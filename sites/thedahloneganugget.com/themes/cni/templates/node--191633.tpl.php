...
if(isset($_POST['submit']))
{
  ...
  else if($response12->GetPublicationIDResult== 3198)
  {
    ...
    {
      $msg="Your Subscription has been expired  <a href='http://www.etypeservices.com/Subscriber/SignIn.aspx?IssueID=111047&ReturnUrl=http://www.etypeservices.com/Subscriber/ReSubscribe.aspx?PubID=3198'>Click here</a>  to re-subscribe.";
    }
    else
    {
      global $user;
