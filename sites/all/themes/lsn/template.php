...
function lsn_preprocess_page(&$variables) {
...
function lsn_preprocess_node(&$variables) {
  $node = $variables['node'];
...
function lsn_breadcrumb($variables) {
...
function lsn_form_alter(&$form, &$form_state, $form_id) {
...
function lsn_preprocess_html(&$vars) {
