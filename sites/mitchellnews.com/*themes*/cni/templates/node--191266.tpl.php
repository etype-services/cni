...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 3533)
    {
...
{
   $msg="Your Subscription has been expired  <a href='http://www.etypeservices.com/Subscriber/SignIn.aspx?IssueID=122234&ReturnUrl=http://www.etypeservices.com/Subscriber/ReSubscribe.aspx?PubID=3533'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
