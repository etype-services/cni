...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 3188)
    {
...
{
   $msg="Your Subscription has been expired  <a href='http://www.etypeservices.com/Subscriber/SignIn.aspx?ReturnUrl=http://www.etypeservices.com/SWF/LocalUser/Franklinco1//Magazine105369/Trial/index.aspx?II=105369&IssueID=105369'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
