...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 3233)
    {
...
{
   $msg="Your Subscription has been expired  <a href='http://www.etypeservices.com/Subscriber/SignIn.aspx?IssueID=110995&ReturnUrl=http://www.etypeservices.com/Subscriber/ReSubscribe.aspx?PubID=3233'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
